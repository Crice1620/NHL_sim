...
find_season_games <- function(season_end_year) {
  ...
  # IMPORTANT: bound the end to THIS season's end, not always today — a
  # season is over well before July of its ending year, and using Sys.Date()
  # unconditionally would sweep in every LATER season's games too when
  # backfilling an older season.
