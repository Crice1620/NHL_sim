...
# - backfill mode: bigger cap since it's a deliberate bulk job — combined
#   with the "already processed" state file, re-triggering the backfill
#   workflow a few times powers through a whole season's backlog.
MAX_GAMES_PER_RUN <- if (MODE == "backfill") 200L else 50L
