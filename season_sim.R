...
if (!is.null(proj_skater_onice)) skater_output <- skater_output %>% left_join(proj_skater_onice, by = "player_id")
else { skater_output$onice_ca_pg <- NA_real_; skater_output$onice_cf_pg <- NA_real_ }
